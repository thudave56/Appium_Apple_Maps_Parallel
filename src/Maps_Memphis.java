...
public class Maps_Memphis {
	...
	public void f() {
			...
			try {
	            reportiumClient.testStart("Open Maps - Memphis, TN", new TestContext("davidde", "_maps"));
	            ...
	            reportiumClient.testStep("step2: Enter Memphis, TN");
	            driver.findElementByXPath("//*[@label=\"Search for a place or address\" or @label=\"Search for place or address\"]").sendKeys("Memphis, TN");
	            
	            reportiumClient.testStep("step3: Validate Wilmington, DE in Results & Click");
	            driver.findElementByXPath("//*[@label=\"Memphis, TN, United States\"]").click();
	            
	            reportiumClient.testStep("step4: Validate Marion is visible -town close to Memphis, TN");
	            driver.findElementsByXPath("//*[@label=\"Marion\"]");
