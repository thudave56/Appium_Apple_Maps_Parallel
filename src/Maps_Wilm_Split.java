	...
	public void maps_Wilmington() {
			...
			ReportiumClient reportiumClient = new ReportiumClientFactory().createPerfectoReportiumClient(perfectoExecutionContext);
			   ...
			   // Reporting client. For more details, see http://developers.perfectomobile.com/display/PD/Reporting
	            ...
	            driver.findElementByXPath("//*[@label=\"Search for a place or address\" or @label=\"Search for place or address\"]").sendKeys("Wilmington, DE");
		...
		ReportiumClient reportiumClient = new ReportiumClientFactory().createPerfectoReportiumClient(perfectoExecutionContext);
		   ...
		   // Reporting client. For more details, see http://developers.perfectomobile.com/display/PD/Reporting
        	   try {
        		...
        		reportiumClient.testStart("Open Maps - Philadelphia, PA", new TestContext("davidde", "maps"));
            // write your code here
            switchToContext(driver, "NATIVE_APP");
            reportiumClient.testStep("step1: Open Application");
            Map<String, Object> openMaps = new HashMap<>();
            ...
            reportiumClient.testStep("step2: Enter Philadelphia, PA");
            driver.findElementByXPath("//*[@label=\"Search for a place or address\" or @label=\"Search for place or address\"]").sendKeys("Philadelphia, PA");
            
            reportiumClient.testStep("step3: Validate Philadelphia, PA in Results & Click");
            driver.findElementsByXPath("//*[@label=\"Philadelphia, PA, United States\"]");
            driver.findElementByXPath("//*[@label=\"Philadelphia, PA, United States\"]").click();
            
            reportiumClient.testStep("step4: Validate Cherry Hill is visible -town close to Philadelphia, PA");
            driver.findElementsByXPath("//*[@label=\"Cherry Hill\"]");
